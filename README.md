...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-73e6qqi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-73e6qqi.containers.anotherwebservice.com/
...
```
git clone git@github.com:DerpyMario/container-73e6qqi.git
cd container-73e6qqi
```
...
```
docker attach container-73e6qqi
```
